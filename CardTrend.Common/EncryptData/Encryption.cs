...
namespace CardTrend.Common.EncryptData
{
   public class Encryption
    {
        ...
        public static string Decrypt(string cipherText)
        {
            ...
            {
                cipherText = cipherText.Replace(ENDKEY, string.Empty);
            }
        ...
        public static bool IsEncrypt(string text)
        {
            return text.EndsWith(ENDKEY);
        }
    }
}
