(function () {
    ...
    var applicationFactory = function ($http, $rootScope) {
        ...
        SaveMilestoneMerchant = function (obj) {
            return $http({
                url: $rootScope.getRootUrl() + '/Applications/SaveMilestoneMerchant',
                method: 'POST',
                data: obj
            });
        }
        return {
            ...
            SaveMilestoneMerchant: SaveMilestoneMerchant
        }
    };

    applicationFactory.$inject = injectParams;
    angular.module('CardtrendApp').factory('Api', applicationFactory);
}());