...
function widthFunctions(e) {
    ...
    if (!$("body").hasClass("static-sidebar")) {
        var s = $(".sidebar-header").outerHeight(),
            o = $(".sidebar-footer").outerHeight();
        if (i < 992) var u = s + o;
        else
            var u = t + s + o;
...
$(document).ready(function (e) {
    ...
    e(".nav-sidebar").on("click", "a", function (t) {
        ...
        if (!e(this).parent().hasClass("hover")) if (e(this).parent().find("ul").size() != 0) {
        ...
        } else e(this).parent().parent().parent().hasClass("opened") || e(".nav a").not(this).parent().find("ul").slideUp("fast", function () {
            e(this).parent().removeClass("opened").find(".opened").each(function () {
                e(this).removeClass("opened")
            })
        })
    ...
    e("#main-menu-toggle").click(function () {
        if (e("body").hasClass("sidebar-hidden")) {
            e("body").removeClass("sidebar-hidden");
            $('.navbar-brand img').velocity({ height: 100 }, {
                duration: 400,
                easing: "swing",
            });
        } else {
            e("body").addClass("sidebar-hidden");
